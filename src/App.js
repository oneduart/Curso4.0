...
// --- 🔴 CONFIGURAÇÃO DO FIREBASE (PASSO CRÍTICO) ---
...
// Inicializando Firebase (Só se a config estiver preenchida para evitar erro em branco)
let auth, db;
try {
  ...
  console.error(
    "Erro Firebase: Provavelmente as chaves não foram configuradas no código."
  );
}
...
const courseData = {
  ...
  modules: [
      ...
      slides: [
        {
          ...
          type: "theory",
          content: [
            "Informática é a ciência da informação.",
            "Usamos computadores para criar e guardar coisas.",
          ],
        },
        {
          ...
          type: "concept",
          content: [
            "HARDWARE: O que você chuta (físico).",
            "SOFTWARE: O que você xinga (programas).",
          ],
        },
        {
          title: "Atividade Prática",
          type: "activity",
          content: ["Liste 3 eletrônicos da sua casa e diga se têm tela."],
        },
      ],
    },
    {
      ...
      description: "Peças do computador.",
      slides: [
        {
          title: "Gabinete e CPU",
          type: "theory",
          content: ["Gabinete é a caixa. CPU é o cérebro."],
        },
        {
          title: "Memória RAM",
          type: "concept",
          content: ["RAM é a mesa de trabalho. Apaga quando desliga."],
        },
        {
          title: "Atividade",
          type: "activity",
          content: ["Desenhe um computador e aponte onde fica o cérebro."],
        },
      ],
    },
    {
      ...
      description: "Mouse, Teclado e mais.",
      slides: [
        {
          title: "Entrada e Saída",
          type: "theory",
          content: [
            "Teclado envia dados (Entrada). Monitor mostra dados (Saída).",
          ],
        },
      ],
    },
    {
      ...
      description: "Dominando o Windows.",
      slides: [
        {
          title: "Área de Trabalho",
          type: "theory",
          content: ["É sua mesa digital. Organize seus ícones."],
        },
      ],
    },
    {
      ...
      description: "Digitando rápido.",
      slides: [
        {
          title: "Posição das Mãos",
          type: "activity",
          content: ["Coloque os indicadores nas teclas F e J."],
        },
      ],
    },
    {
      ...
      slides: [
        {
          title: "Formatando",
          type: "concept",
          content: ["Negrito, Itálico e Cores deixam o texto bonito."],
        },
      ],
    },
    {
      ...
      slides: [
        {
          title: "Slides",
          type: "theory",
          content: ["Pouco texto e muita imagem!"],
        },
      ],
    },
    {
      ...
      slides: [
        {
          title: "Células",
          type: "concept",
          content: ["Linhas (Números) e Colunas (Letras)."],
        },
      ],
    },
    {
      ...
      description: "Navegação Segura.",
      slides: [
        {
          title: "Senhas",
          type: "theory",
          content: ["Não use 123456! Misture letras e números."],
        },
      ],
    },
    {
      ...
      slides: [
        {
          title: "Entrega",
          type: "activity",
          content: ["Crie uma pasta com seu nome e salve seus trabalhos."],
        },
      ],
    },
  ],
...
const AuthScreen = ({ onLogin }) => {
  ...
  const handleAuth = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setError(
        err.message.includes("auth") ? "Erro de email ou senha." : err.message
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-md animate-fadeIn">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800">
            {isLogin ? "Entrar na Aula" : "Criar Conta"}
          </h1>
          <p className="text-gray-500 text-sm">
            Salve seu progresso na nuvem! ☁️
          </p>
        </div>
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y">
              {students.map((student) => {
                const progress = student.completedModules
...
// --- COMPONENTES DO CURSO (Simplificados para caber no exemplo) ---
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-100 flex flex-col animate-fadeIn">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-2xl w-full text-center border-4 border-blue-100">
          <span className="uppercase text-xs font-bold text-blue-400 tracking-widest mb-4 block">
            {slide.type}
          </span>
          ...
          <div className="space-y-4 text-lg text-left inline-block">
            {slide.content.map((t, i) => (
              <p key={i} className="flex gap-2">
                <ArrowRight size={20} className="text-blue-500 shrink-0" /> {t}
              </p>
            ))}
          </div>
          <button
            onClick={handleNext}
            className="mt-8 w-full bg-blue-600 text-white py-3 rounded-xl font-bold hover:scale-105 transition-transform"
          >
...
const ModuleCard = ({ module, isCompleted, onClick }) => (
  <div
    onClick={onClick}
    className={`p-4 mb-3 bg-white rounded-xl border-2 flex items-center justify-between cursor-pointer hover:border-blue-300 transition ${
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              {userData?.role === "teacher" ? "Professor(a)" : "Aluno(a)"}
            </p>
          </div>
        </div>
        <button
          ...
          <div className="flex gap-2 mb-6 bg-gray-200 p-1 rounded-lg">
            <button
              ...
              className={`flex-1 py-2 text-sm font-bold rounded-md ${
                view === "modules" ? "bg-white shadow" : "text-gray-600"
              }`}
            >
              Ver Curso
            </button>
            <button
              ...
              className={`flex-1 py-2 text-sm font-bold rounded-md ${
                view === "teacher" ? "bg-white shadow" : "text-gray-600"
              }`}
            >
              Área do Professor
            </button>
